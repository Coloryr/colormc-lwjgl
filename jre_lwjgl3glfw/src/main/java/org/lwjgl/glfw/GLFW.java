...
public class GLFW
{
    ...
    static {
        ...
        try {
            System.loadLibrary("colormcnative_run");
    ...
    private static final SharedLibrary GLFW = Library.loadNative(GLFW.class, "org.lwjgl.glfw", "libcolormcnative_run.so", true);
    ...
    public static final class Functions {
        ...
        Init = apiGetFunctionAddress(GLFW, "colormcInit"),
        CreateContext = apiGetFunctionAddress(GLFW, "colormcCreateContext"),
        GetCurrentContext = apiGetFunctionAddress(GLFW, "colormcGetCurrentContext"),
        //DetachOnCurrentThread = apiGetFunctionAddress(GLFW, "colormcDetachOnCurrentThread"),
        MakeContextCurrent = apiGetFunctionAddress(GLFW, "colormcMakeCurrent"),
        Terminate = apiGetFunctionAddress(GLFW, "colormcTerminate"),
        SetWindowHint = apiGetFunctionAddress(GLFW, "colormcSetWindowHint"),
        SwapBuffers = apiGetFunctionAddress(GLFW, "colormcSwapBuffers"),
        SwapInterval = apiGetFunctionAddress(GLFW, "colormcSwapInterval"),
        PumpEvents = apiGetFunctionAddress(GLFW, "colormcPumpEvents"),
        StopPumping = apiGetFunctionAddress(GLFW, "colormcStopPumping"),
        StartPumping = apiGetFunctionAddress(GLFW, "colormcStartPumping");
    }
